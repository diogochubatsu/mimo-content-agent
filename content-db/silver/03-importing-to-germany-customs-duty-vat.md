...
source: "customs-lookup.com" url: "https://www.customs-lookup.com/country/de/" date: "2026-01-01" summary: "Quick reference guide to importing goods into Germany including customs duties, VAT rates, de minimis thresholds, and import procedures." tags: ["germany", "import", "customs-duty", "VAT", "Mw

source: "customs-lookup.com"

url: "https://www.customs-lookup.com/country/de/"

date: "2026-01-01"

summary: "Quick reference guide to importing goods into Germany including customs duties, VAT rates, de minimis thresholds, and import procedures."

tags: ["germany", "import", "customs-duty", "VAT", "MwSt", "de-minimis", "regulations"]

language: "en"

category: "import-overview"

| Aspect | Detail |

|--------|--------|

| Customs Authority | Zollverwaltung (German Customs) |

| De minimis threshold | €150 (~$165 USD) |

| VAT / sales tax | MwSt (Mehrwertsteuer) at 19% (7% reduced for food and books) |

| Typical duty range | 0–12% EU Common Customs Tariff |

| Code system | 8-digit CN codes — EU standard |

| Currency | EUR |

- EU tariffs on Chinese EVs: 17–38% additional

- US reciprocal tariffs affecting EU-US trade flows
